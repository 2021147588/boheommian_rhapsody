...
class InsuranceProductDB:
    ...
    def __init__(self):
        ...
        self.coverage_details = {
            "자동차사고변호사선임비용Ⅴ": {"고급형": "8,000만원", "표준형": "5,000만원", "3400형": "3,000만원", "description": "자동차 운전 중 사고로 타인 상해 발생 시 구속, 공소 제기, 정식재판 청구, 경찰조사 후 불송치/약식기소/불기소 시 변호사 선임 비용 실손 보상 (공탁금 70% 선지급 가능)"},
            "자동차사고대인벌금Ⅱ": {"고급형": "5,000만원", "표준형": "3,000만원", "3400형": "2,000만원", "description": "자동차 운전 중 또는 비탑승 중 사고로 타인 신체 상해 관련 벌금 확정 시 실손 보상 (일반 2천만원 한도, 스쿨존 어린이 치사상 시 3천만원 한도)"},
            "자동차사고대물벌금": {"고급형": "1,000만원", "표준형": "500만원", "3400형": "300만원", "description": "자동차 운전 중 사고로 도로교통법 제151조에 따른 대물 벌금형 확정 시 실손 보상 (음주/무면허 제외)"},
            "대인형사합의실손비Ⅲ": {"고급형": "3억원", "표준형": "2억원", "3400형": "1억원", "description": "자동차 운전 중 또는 비탑승 중 사고로 타인 사망, 중상해(공소제기 또는 부상등급 1~3급), 중대법규위반(42일 이상 진단, 스쿨존 42일 미만 포함) 시 형사합의금 실손 보상 (공탁금 100% 선지급 가능)"},
            "원격지사고시운반비용": {"고급형": "50만원", "표준형": "30만원", "3400형": "20만원", "description": "자가용 운전 중 원격지(20km 초과 이동) 사고 시 발생한 운반 비용 실손 보상 (1사고당 한도)"},
            "보복운전피해보장": {"고급형": "100만원", "표준형": "50만원", "3400형": "30만원", "description": "보복운전 피해자로 공소제기 또는 기소유예 시 보험가입금액 지급 (1사고당 1회)"},
            "보복운전피해보장Ⅱ": {"고급형": "100만원", "표준형": "70만원", "3400형": "50만원", "description": "보복운전 피해로 신체 피해 또는 자동차/부착물 손해 발생 및 공소제기/기소유예 시 보험가입금액 지급 (정신적/심리적 피해만 있는 경우 제외, 1사고당 1회)"},
            "대인형사합의실손비Ⅲ (중대법규위반, 42일미만)": {"고급형": "2,000만원", "표준형": "1,500만원", "3400형": "1,000만원", "description": "자동차 운전 중 중대법규위반 사고로 타인에게 42일 미만 진단 발생 시 형사합의금 실손 보상 (진단일수별 차등, 공탁금 100% 선지급 가능)"},
            "자동차사고부상발생금 (1-7급, 단일지급)": {"고급형": "1,000만원", "표준형": "500만원", "3400형": "100만원", "description": "자동차사고로 부상등급 1~7급 해당 시 보험가입금액 지급"},
            "자동차사고부상발생금 (1-14급, 차등지급)": {"고급형": "100만원", "표준형": "50만원", "3400형": "10만원", "description": "자동차사고로 부상등급 1~14급 해당 시 부상등급별 차등 지급 (보험가입금액 기준)"},
            "교통상해사망": {"고급형": "1억원", "표준형": "5,000만원", "3400형": "1,000만원", "description": "교통상해사고로 사망 시 보험가입금액 지급"},
            "상해수술비": {"고급형": "100만원", "표준형": "50만원", "3400형": "10만원", "description": "상해사고의 직접 결과로 수술 시 보험가입금액 지급 (1회 한)"},
            "상해흉터복원수술비Ⅱ": {"고급형": "2,000만원", "표준형": "1,500만원", "3400형": "1,000만원", "description": "상해 치료 후 안면부/상지/하지 흉터 발생 시 원상회복 목적의 성형수술 비용 (사고 후 2년 내, 1cm당 차등 지급, 동일부위 1회 한)"},
            "응급실내원치료비 (응급)": {"고급형": "10만원", "표준형": "5만원", "3400형": "1만원", "description": "상해 또는 질병으로 응급환자에 해당하여 응급실 내원 진료 시 (1회당)"},
            "응급실내원치료비 (비응급)": {"고급형": "10만원", "표준형": "5만원", "3400형": "1만원", "description": "비응급환자이나 상해 또는 질병으로 응급실 내원 진료 시 (1회당)"},
            "골절 (치아파절제외) 진단비": {"고급형": "100만원", "표준형": "50만원", "3400형": "10만원", "description": "상해사고로 골절(치아파절 제외) 진단 확정 시 (1회 한)"},
            "깁스치료비": {"고급형": "50만원", "표준형": "30만원", "3400형": "10만원", "description": "질병 또는 상해로 깁스(Cast) 치료 시 (부목 제외, 1회 한)"},
            "골절 (치아파절제외) 깁스치료비": {"고급형": "50만원", "표준형": "30만원", "3400형": "20만원", "description": "골절(치아파절 제외) 진단 후 깁스(Cast) 치료 시 (1회 한)"},
            "골절 (치아파절제외) 부목치료비": {"고급형": "20만원", "표준형": "10만원", "3400형": "5만원", "description": "골절(치아파절 제외) 진단 후 부목(Splint Cast) 치료 시 (1회 한)"},
            "특정상해성뇌손상진단비": {"고급형": "300만원", "표준형": "200만원", "3400형": "100만원", "description": "특정상해성뇌손상 진단 확정 시 (최초 1회)"},
            "특정상해성장기손상진단비": {"고급형": "300만원", "표준형": "200만원", "3400형": "100만원", "description": "특정상해성장기손상 진단 확정 시 (최초 1회)"},
            "특정상해성뇌출혈진단비": {"고급형": "3,000만원", "표준형": "2,000만원", "3400형": "1,000만원", "description": "특정상해성뇌출혈 진단 확정 시 (최초 1회)"},
            "상해성뇌출혈수술비": {"고급형": "300만원", "표준형": "200만원", "3400형": "100만원", "description": "상해성뇌출혈 진단 후 직접 치료 목적 수술 시 (수술 1회당)"},
            "민사소송법률비용Ⅱ (실손)": {"고급형": "5,000만원", "표준형": "4,000만원", "3400형": "3,000만원", "description": "보험기간 중 민사소송 제기되어 판결/조정/화해로 종료 시 법률비용 실손 보상 (변호사비용 2천만원, 인지/송달료 1천만원 한도, 자기부담금 있음)"}
        }
...
class AdvancedRecommendationAgent(AdvancedBaseAgent):
    def __init__(self):
        ...
        super().__init__(
            ...
            system_message=(
                ...
                "1. 제공된 고객 프로필 정보를 바탕으로 최적의 운전자보험 **플랜 유형(고급형, 표준형, 3400형)**과 해당 플랜의 **주요 보장 및 금액**을 고려하여 추천합니다.\n"
                "2. 각 플랜 유형에 포함된 보장 내용과 **금액**을 고객의 상황에 맞게 설명합니다.\n"
                "3. 여러 플랜 유형의 **보장 내용과 금액**을 비교 분석하여 고객이 최선의 선택을 할 수 있도록 돕습니다.\n"
                "4. 추천 과정에서 필요한 추가 정보가 있다면 질문을 통해 수집합니다.\n"
                "5. 플랜 유형 추천을 완료한 후에는 즉시 영업 에이전트로 전환하여 가입 상담을 진행합니다.\n"
                "항상 객관적이고 정확한 정보를 제공하되, 실제 가입 상담은 영업 에이전트가 담당하도록 합니다. 추천을 할 때 항상 {고급형, 표준형, 3400형} 중 하나를 먼저 언급하고 자세히 설명합니다."
            ),
            model="gpt-4o-mini",
            tools=[
    ...
    def recommend_insurance_plan(self, profile_data: str):
        ...
        Returns:
            AdvancedSalesAgent: 영업 에이전트 객체 (추천 플랜 유형이 설정된 상태)
        """
        try:
            # 프로필 정보 파싱
            ...
            또한, 응답 마지막에 'RECOMMENDED_PLAN:플랜유형' 형식으로 별도 표기해주세요. 예: 'RECOMMENDED_PLAN:고급형'
            """
            ...
            plan_marker = "RECOMMENDED_PLAN:"
            
            if plan_marker in recommendation:
                # 마커를 통해 직접 추출
                marker_index = recommendation.find(plan_marker)
                if marker_index >= 0:
                    plan_text = recommendation[marker_index + len(plan_marker):].strip()
                    # 첫 줄만 가져오거나 줄바꿈 기준으로 분리
                    recommended_plan = plan_text.split('\n')[0].strip()
            
            # 마커가 없는 경우 추가 프롬프트로 플랜 추출
            if not recommended_plan or recommended_plan not in ["고급형", "표준형", "3400형"]:
                extract_prompt = f"""
                다음 텍스트에서 추천하는 보험 플랜 유형이 '고급형', '표준형', '3400형' 중 무엇인지 정확히 한 단어로만 응답하세요:
                
                {recommendation}
                """
                extract_response = self.openai_client.chat.completions.create(
                    model="gpt-4o-mini",
                    messages=[{"role": "user", "content": extract_prompt}],
                    temperature=0.1
                )
                recommended_plan = extract_response.choices[0].message.content.strip()
                
                # 유효한 플랜 유형 확인
                if recommended_plan not in ["고급형", "표준형", "3400형"]:
                    recommended_plan = "표준형"  # 기본값 설정
            
            # 마커 제거
            if plan_marker in recommendation:
                recommendation = recommendation[:recommendation.find(plan_marker)].strip()
            ...
            # 추천 플랜 정보 설정
            if hasattr(sales_agent, 'customer_profile'):
                if hasattr(sales_agent.customer_profile, 'selected_plan_type'):
                    sales_agent.customer_profile.selected_plan_type = recommended_plan
                    print(f"[RecommendationAgent] 추천 플랜 유형 '{recommended_plan}'을(를) 영업 에이전트에 전달합니다.")
                else:
                    print(f"[RecommendationAgent] 추천 플랜 유형 '{recommended_plan}' 확인. (customer_profile에 'selected_plan_type' 속성 없음)")
            else:
                print(f"[RecommendationAgent] 추천 플랜 유형 '{recommended_plan}' 확인. (영업 에이전트에 customer_profile이 없음)")
            
            # 영업 에이전트의 초기 대화 메시지 설정
            sales_agent.initial_message = recommendation + "\n\n이제 영업 담당자가 상품 가입에 대해 더 자세히 안내해 드리겠습니다."
            ...
            # 오류 발생 시에도 영업 에이전트 객체 반환
            from agents.advanced_agents.sales_agent import AdvancedSalesAgent
            sales_agent = AdvancedSalesAgent()
            sales_agent.initial_message = "플랜 추천 생성 중 오류가 발생했습니다. 정확한 고객 프로필 정보가 필요합니다. 어떤 플랜에 관심이 있으신가요?"
            return sales_agent
